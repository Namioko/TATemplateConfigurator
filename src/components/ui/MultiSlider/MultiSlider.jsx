...
export default class MultiSlider extends React.Component {
    ...
    calculateValues() {
        return [Math.max(0, this.props.negativeEnd - 1),
            this.props.positiveStart - this.props.negativeEnd - 1,
            Math.min(11, 11 - this.props.positiveStart + 1)];
    }
    ...
    sum() {
        ...
        return this.calculateValues().reduce(function(a, b) {
            return a + b;
        });
    }
    ...
    onHandleMove = e => {
        ...
        if (left !== leftValue && right !== rightValue
            ...
            this.props.onChange([values[0], values[1] + values[0] + 1]);
        }
    };
    onHandleEnd = e => {
        var event = this.concernedEvent(e);
