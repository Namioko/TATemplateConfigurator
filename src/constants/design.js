export const DEFAULT_CUSTOMER_LOGO = "https://reportal.euro.confirmit.com/cf_clientutil/themes/flattheme/images/logo-gigantic.png";

export const DEFAULT_COLORS = {
    positiveColor:          "#7CC700", //positive color
    neutralColor:           "#CDD1D9", //neutral color
    negativeColor:          "#FD9900", //negative color
    backgroundColor:        "#E1E4E9", //Background, inactive navigation tabs
    headerBackgroundColor:  "#000000", //background for navigation panel, pagetitle and logo
    headerTextColor:        "#FFFFFF", //text color for pagetitle
    ...
    dividerColor:           "#CCCCCC", //color for inputs borders
    lightDividerColor:      "#E1E4E9", //separation line between table rows
    disabledTextColor:      "#CCCCCC", //disabled text color
};
